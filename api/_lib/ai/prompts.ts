...
export function buildPrompt(inputs: ReadingInputs): { system: string; user: string } {
  ...
  const lengthRule = premium
    ? [
        '請寫一篇約 6800–9800 字、結構完整、文字厚實的專業命理老師深度書面報告；若輸出上限不足，優先保留判讀依據、性格分析、事業財運與可執行建議。',
        '寫法要像付費命理老師交付的正式報告：先校盤、再論本命格局、再分項細論，最後給具體調整策略。',
        '每一節都必須引用「系統排盤資料」中的具體依據，例如四柱、日主、五行分布、大運、命宮、主星、宮位、四化、生肖或生命靈數；資料不足時才明確說明保守判讀。',
        '務必依序使用以下中文小節標題，每節先寫 5–8 段深入文字，再附 1 個 Markdown 表格。',
        '一、命盤資料校對',
        '二、性格底盤、優勢天賦與盲點',
        '三、事業／學業與工作定位',
        '四、財運、資源與風險控管',
        ...
        '七、近期三個月節奏與流年提醒',
        '八、開運策略與行動清單',
        '第一節必須列出算命者資料，並逐項校對國曆、農曆、時辰、八字四柱或紫微命盤資料；不可只說「資料正確」。',
        '第二節「性格底盤、優勢天賦與盲點」至少 900–1300 字，需寫得像專業命理老師在做本命性格剖析，包含外顯性格、內在需求、壓力反應、關係模式與成熟課題。',
        '事業、財運、感情三節都要拆成「先天傾向」「容易遇到的情境」「近期可操作策略」三層，不可只給形容詞。',
        '每個表格固定使用 3 欄：面向｜命盤觀察｜具體建議；每列內容 55–120 字，至少 5 列。',
  ...
  const system = [
    ...
    '若系統提供八字四柱、大運或紫微十二宮星曜，必須以這些資料為核心判讀，不可只寫一般生肖、星座或心理測驗式內容。',
